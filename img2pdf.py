...
def process_folder(folder, logger):
    ...
    print("   - Use folder name as PDF name")
    print("   - Add current username as author")
    print()
    print("2. Custom PDF Name")
    print("   - Enter your own PDF name")
    print("   - Add current username as author")
    print()
    print("3. Custom PDF Name & Author")
    print("   - Enter PDF name and author details")
    print()
